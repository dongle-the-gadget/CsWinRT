...
namespace ABI.Windows.UI.Xaml.Interop
{
    ...
    internal sealed unsafe class WinRTNotifyCollectionChangedEventArgsRuntimeClassFactory
    {
        ...
        {
#if NET
            _obj = ActivationFactory.Get("Windows.UI.Xaml.Interop.NotifyCollectionChangedEventArgs", IID.IID_INotifyCollectionChangedEventArgsFactory);
#else
            _obj = ActivationFactory.Get<IUnknownVftbl>("Windows.UI.Xaml.Interop.NotifyCollectionChangedEventArgs", IID.IID_INotifyCollectionChangedEventArgsFactory);
#endif
        }
