...
namespace ABI.System.Collections.Specialized
{
    ...
    {
        private static WinRTNotifyCollectionChangedEventArgsRuntimeClassFactory Instance = ActivationFactory.Get("Windows.UI.Xaml.Interop.NotifyCollectionChangedEventArgs");
