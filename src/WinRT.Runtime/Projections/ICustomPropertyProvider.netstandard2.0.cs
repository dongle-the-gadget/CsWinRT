...
namespace WinRT.Xaml.Data
{
    [global::WinRT.WindowsRuntimeType]
    [Guid("30DA92C0-23E8-42A0-AE7C-734A0E5D2782")]
    [global::WinRT.WindowsRuntimeHelperType(typeof(global::ABI.WinRT.Xaml.Data.ICustomProperty))]
...
namespace ABI.WinRT.Xaml.Data
{
        ...
        public struct Vftbl
        {
            ...
            private static unsafe int Do_Abi_GetValue_2(IntPtr thisPtr, IntPtr target, IntPtr* result)
            {
                ...
                *result = default;
                ...
                try
                {
                    __result = global::WinRT.ComWrappersSupport.FindObject<global::WinRT.Xaml.Data.ICustomProperty>(thisPtr).GetValue(MarshalInspectable<object>.FromAbi(target)); 
            ...
            private static unsafe int Do_Abi_SetValue_3(IntPtr thisPtr, IntPtr target, IntPtr value)
            {
                ...
                try
                {
                    global::WinRT.ComWrappersSupport.FindObject<global::WinRT.Xaml.Data.ICustomProperty>(thisPtr).SetValue(MarshalInspectable<object>.FromAbi(target), MarshalInspectable<object>.FromAbi(value));
                }
                catch (Exception __exception__)
                {
                    global::WinRT.ExceptionHelpers.SetErrorInfo(__exception__);
            ...
            private static unsafe int Do_Abi_GetIndexedValue_4(IntPtr thisPtr, IntPtr target, IntPtr index, IntPtr* result)
            {
                ...
                try
                {
                    __result = global::WinRT.ComWrappersSupport.FindObject<global::WinRT.Xaml.Data.ICustomProperty>(thisPtr).GetIndexedValue(MarshalInspectable<object>.FromAbi(target), MarshalInspectable<object>.FromAbi(index)); 
                    *result = MarshalInspectable<object>.FromManaged(__result);
            ...
            private static unsafe int Do_Abi_SetIndexedValue_5(IntPtr thisPtr, IntPtr target, IntPtr value, IntPtr index)
            {
                ...
                try
                {
                    global::WinRT.ComWrappersSupport.FindObject<global::WinRT.Xaml.Data.ICustomProperty>(thisPtr).SetIndexedValue(MarshalInspectable<object>.FromAbi(target), MarshalInspectable<object>.FromAbi(value), MarshalInspectable<object>.FromAbi(index));
                }
                catch (Exception __exception__)
                {
                    global::WinRT.ExceptionHelpers.SetErrorInfo(__exception__);
            ...
            private static unsafe int Do_Abi_get_CanRead_7(IntPtr thisPtr, byte* value)
            {
                ...
                try
                {
                    __value = global::WinRT.ComWrappersSupport.FindObject<global::WinRT.Xaml.Data.ICustomProperty>(thisPtr).CanRead; *value = (byte)(__value ? 1 : 0);
            ...
            private static unsafe int Do_Abi_get_CanWrite_6(IntPtr thisPtr, byte* value)
            {
                ...
                try
                {
                    __value = global::WinRT.ComWrappersSupport.FindObject<global::WinRT.Xaml.Data.ICustomProperty>(thisPtr).CanWrite; *value = (byte)(__value ? 1 : 0);
            ...
            private static unsafe int Do_Abi_get_Name_1(IntPtr thisPtr, IntPtr* value)
            {
                ...
                try
                {
                    __value = global::WinRT.ComWrappersSupport.FindObject<global::WinRT.Xaml.Data.ICustomProperty>(thisPtr).Name; 
            ...
            private static unsafe int Do_Abi_get_Type_0(IntPtr thisPtr, global::ABI.System.Type* value)
            {
                ...
                try
                {
                    __value = global::WinRT.ComWrappersSupport.FindObject<global::WinRT.Xaml.Data.ICustomProperty>(thisPtr).Type; 
    ...
    internal sealed class ManagedCustomProperty : global::WinRT.Xaml.Data.ICustomProperty
    {
    ...
    internal unsafe struct ManagedCustomPropertyProviderVftbl
    {
        ...
        {
            global::WinRT.Xaml.Data.ICustomProperty __result = default;
            try
            {
                ...
                *result = MarshalInterface<global::WinRT.Xaml.Data.ICustomProperty>.FromManaged(__result);
