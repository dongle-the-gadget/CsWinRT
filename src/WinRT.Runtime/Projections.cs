...
namespace WinRT
{
    ...
    static partial class Projections
    {
        ...
        static Projections()
        {
            ...
            RegisterCustomAbiTypeMappingNoLock(typeof(ICommand), typeof(ABI.System.Windows.Input.ICommand), "Windows.UI.Xaml.Input.ICommand");
            ...
            RegisterCustomTypeToHelperTypeMappingNoLock(typeof(Windows.UI.Xaml.Interop.IBindableVector), typeof(ABI.System.Collections.IList));
