            ...
            using (iErrorInfo)
            {
                switch (hr)
                {
                    ...
                    case E_XAMLPARSEFAILED:
                        ex = XamlSupport.XamlNamespace == XamlNamespace.WUX ? new Windows.UI.Xaml.Markup.XamlParseException() : new Microsoft.UI.Xaml.Markup.XamlParseException();
                        break;
                    case E_LAYOUTCYCLE:
                        ex = XamlSupport.XamlNamespace == XamlNamespace.WUX ? new Windows.UI.Xaml.LayoutCycleException() : new Microsoft.UI.Xaml.LayoutCycleException();
                        break;
                    case E_ELEMENTNOTAVAILABLE:
                        ex = XamlSupport.XamlNamespace == XamlNamespace.WUX ? new Windows.UI.Xaml.Automation.ElementNotAvailableException() : new Microsoft.UI.Xaml.Automation.ElementNotAvailableException();
                        break;
                    case E_ELEMENTNOTENABLED:
                        ex = XamlSupport.XamlNamespace == XamlNamespace.WUX ? new Windows.UI.Xaml.Automation.ElementNotEnabledException() : new Microsoft.UI.Xaml.Automation.ElementNotEnabledException();
                        break;
